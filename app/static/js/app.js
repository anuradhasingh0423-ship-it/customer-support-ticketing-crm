...
async function runAIAssist() {
    ...
    const button =
        document.getElementById("aiAssistBtn");
    ...
    resultBox.innerHTML = `
        <p style="
            ...
            color: #6b7280;
        ">
            AI is analyzing this ticket. Please wait...
        </p>
    `;

    const notesText =
        currentTicket.notes && currentTicket.notes.length
            ? currentTicket.notes
    ...
    try {
        ...
        resultBox.innerHTML = `
            <p style="
                ...
                margin: 0;
            ">
                AI assistant could not process this ticket.
                Please try again.
            </p>
        `;
